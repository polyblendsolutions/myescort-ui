...
export class CreateAdsThreeComponent implements OnInit {
  ...
  initForm() {
    this.dataForm = this.fb.group({
      ...
      height: [null, [ Validators.pattern('^[0-9]*$'), Validators.min(150), Validators.max(200)]],
      weight: [null, [ Validators.pattern('^[0-9]*$'), Validators.min(50), Validators.max(300)]],
      runningOut: [null],
      acceptsPeople: [null],
      size: [null],
      specialHours: [null],
   ...
   */
    ...
    initUpdateForm(data:any) {
      this.dataForm = this.fb.group({
        ...
        height: [data?.height, [ Validators.pattern('^[0-9]*$'), Validators.min(150), Validators.max(200)]],
        weight: [data?.weight, [ Validators.pattern('^[0-9]*$'), Validators.min(50), Validators.max(300)]],
