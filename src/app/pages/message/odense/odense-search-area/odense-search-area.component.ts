...
@Component({
  selector: 'app-odense-search-area',
  templateUrl: './odense-search-area.component.html',
  styleUrls: ['./odense-search-area.component.scss'],
})
export class OdenseSearchAreaComponent implements OnInit, OnDestroy {
