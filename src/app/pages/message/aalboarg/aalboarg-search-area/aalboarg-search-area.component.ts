...
@Component({
  selector: 'app-aalboarg-search-area',
  templateUrl: './aalboarg-search-area.component.html',
  styleUrls: ['./aalboarg-search-area.component.scss'],
})
export class AalboargSearchAreaComponent implements OnInit, OnDestroy {
